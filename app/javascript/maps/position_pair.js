import { getMarker, getLatLng } from "../maps/index.js";
...
export default class PositionPair {
  ...
  distanceBetweenPositions() {
    return this.haversineDistance(this.startPosition(), this.endPosition());
  }
  ...
  color() {
    return this.colorFromSpeed(this.el1.speed, this.el2.speed);
  }
  ...
  hasGap() {
    return (
      this.distanceBetweenPositions() > 5.0 ||
  ...
  differenceInHours(datetime1, datetime2) {
    return Math.floor(
      ((new Date(datetime2) - new Date(datetime1)) % 86400000) / 3600000
    );
  }
